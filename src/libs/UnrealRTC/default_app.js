...
function setupWebRtcPlayer(htmlElement, config) {
	...
	// ENVA: dispatch a message to indicate that playback has begun; this should allow
	// the game to understand when a player has joined
	webRtcPlayerObj.video.addEventListener('play', () => {
		// window.parent.postMessage({"type": "started_pixel_stream", "data": ""}, "*");
		console.log("webRtcPlayerObj.video fired play event");
		emitUIInteraction({"type": "started_pixel_stream", "data": ""});
	}, {"once": true});
...
function connect() {
	...
	//CHANGES
	ws = new WebSocket("wss://ps2.neonexperiment.com:446/");
